...
data=pd.read_csv(input_folder+"MICenvironment_weather_v6_modified.csv",sep=",")
...
items_2_remove_A=['Datum', 'mdr','nwt','nwt']
...
for i in range(10000):
    print(i)
    with HiddenPrints():
        df_A,df_B,acc_A,acc_B,prec_A,prec_B,rec_A,rec_B,model_A,model_B,data_A,data_B=run_two_rf_BS(data,group_by='Datum',target="mdr",vars_2_rm_A=items_2_remove_A,vars_2_rm_B=items_2_remove_B,trainvalsplit=.2)
...
choice=[16,17,18,19,20,21] # v3
choice=[15,16,17,18,19,20] # v6
# In[ ]:
...
plot_feature_direction_grayspace(data=data_A,var_choice=choice,model_list=model_A_list,plot_folder=plot_folder,name_modifier="MICenvironment_weather_mdr",grid_points=50)
...
for i in range(10000):
    print(i)
    with HiddenPrints():
        df_A,df_B,acc_A,acc_B,prec_A,prec_B,rec_A,rec_B,model_A,model_B,data_A,data_B=run_two_rf_BS(data,group_by='Datum',target="nwt",vars_2_rm_A=items_2_remove_A,vars_2_rm_B=items_2_remove_B,trainvalsplit=.2)
    df_11_list.append(df_A)
    df_22_list.append(df_B)
    acc_A_list.append(acc_A)
    acc_B_list.append(acc_B)
...
plot_feature_direction_grayspace(data=data_A,var_choice=choice,model_list=model_A_list,plot_folder=plot_folder,name_modifier="MICenvironment_weather_nwt",grid_points=50)
